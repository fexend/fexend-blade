        ...
        <div class="sidebar-icon z-20">
            <div>
                <div class="inline-flex h-16 w-16 items-center justify-center">
                    <a href="{{ route('settings.index') }}" x-data="{ tooltip: false }" @mouseover="tooltip = true" @mouseleave="tooltip = false" class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-primary dark:hover:bg-primary-dark dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">
                ...
                <div class="border-t border-gray-100 dark:border-gray-700">
                    <div class="px-2">
                        <ul class="space-y-1 border-t border-gray-100 dark:border-gray-700 pt-4">
                            ...
                            <li>
                                <a href="{{ route('master.index') }}" x-data="{ tooltip: false }" @mouseover="tooltip = true" @mouseleave="tooltip = false" class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-primary dark:hover:bg-primary-dark dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">
                                    <!-- Master -->
                                    ...
                                    <span x-show="tooltip" x-transition class="absolute left-full ml-2 top-1/2 transform -translate-y-1/2 w-max bg-slate-800 text-white rounded py-1 px-2 whitespace-nowrap z-[100] font-normal">Master</span>
                                </a>
                            </li>
